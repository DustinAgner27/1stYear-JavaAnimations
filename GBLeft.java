...
This class the creates the left part of the Game Boy. The object was created using a rounded rectangle and curves.
**/
/*
...
public class GBLeft implements DrawingObject {
    private double x;
    private double y;
    ...
    public GBLeft(double x, double y, double width, double height, Color color){
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
        ...
        rrect = new RoundRectangle2D.Double(-width/2.35+9, height*.1, width/2.35, height*.9, 30, 40);
